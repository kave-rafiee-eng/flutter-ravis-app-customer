...
class RendererSettingMultiGroupTerseData {
  ...
  RendererSettingMultiGroupTerseData({
...
// void _renderSelectGroup(
//   LcdFunctions lcd,
//   RendererSettingMultiGroupTerseData data,
// ) {
...
void _renderLcd(LcdFunctions lcd, RendererSettingMultiGroupTerseData data) {}

class RenderSettingMultiGroupTesre extends StatefulWidget {
  final RendererSettingMultiGroupTerseData inputData;
  final double cellSize;
  final LanguageEnum language;

  const RenderSettingMultiGroupTesre({
    super.key,
  ...
  @override
  createState() => _RenderSettingMultiGroupTerseState();
}

class _RenderSettingMultiGroupTerseState
    extends State<RenderSettingMultiGroupTesre> {
